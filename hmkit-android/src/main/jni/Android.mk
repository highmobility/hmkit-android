...
LOCAL_LDLIBS := -llog
LOCAL_LDLIBS += -lz
LOCAL_C_INCLUDES += $(CORE_PATH)/high-mobility-bt-core
LOCAL_C_INCLUDES += $(CORE_PATH)/crypto-c/Crypto
...
LOCAL_SRC_FILES += $(CORE_PATH)/crypto-c/Crypto/Crypto.c

LOCAL_SRC_FILES += $(CORE_PATH)/high-mobility-bt-core/hm_bt_core.c
LOCAL_SRC_FILES += $(CORE_PATH)/high-mobility-bt-core/hm_bt_log.c
LOCAL_SRC_FILES += $(CORE_PATH)/high-mobility-bt-core/hm_cert.c
LOCAL_SRC_FILES += $(CORE_PATH)/high-mobility-bt-core/hm_conf_access.c
LOCAL_SRC_FILES += $(CORE_PATH)/high-mobility-bt-core/hm_api.c
